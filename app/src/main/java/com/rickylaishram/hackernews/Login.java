...
public class Login extends Activity {
	...
	static String LOGIN_URL 		= "https://news.ycombinator.com/login";
	...
	private class Authenticate extends AsyncTask<String, Void, Integer> {
		...
		protected Integer doInBackground(String... params) {
			...
			try {
				...
				nameValuePairs.add(new BasicNameValuePair("goto", "news"));
				nameValuePairs.add(new BasicNameValuePair("acct", username));
